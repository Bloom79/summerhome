...
const STR = {
  it: {
    ...
    stats_hint: '🌊 con vista mare · 📉 ribassate · 🔴 vendute/ritirate — tocca una zona per filtrarla.',
  ...
  en: {
    ...
    stats_hint: '🌊 sea view · 📉 reduced · 🔴 sold/withdrawn — tap a row to filter that area.',
