...
const STR = {
  it: {
    ...
    map_search_area: '🔎 Filtra con la mappa', map_see_all: '⛶ Vedi tutto', pop_full: 'Scheda completa →',
    ...
    agent_explain: '«🔎 Filtra con la mappa» mostra solo le case già nel portale; da qui invece chiedi all\'agente di cercare NUOVE case in quest\'area.',
    ...
    agent_howto_direct: 'Premendo «Invia la richiesta» la richiesta parte subito, senza login: le nuove case compaiono col prossimo aggiornamento quotidiano, entro 24 ore.',
    ...
    t_agent_ok: 'Richiesta inviata ✅ Le case di questa zona arrivano col prossimo aggiornamento',
  ...
  en: {
    ...
    map_search_area: '🔎 Filter by map view', map_see_all: '⛶ See all', pop_full: 'Full details →',
    ...
    agent_explain: '"🔎 Filter by map view" only shows homes already on the portal; this instead asks the agent to hunt for NEW homes in this area.',
    ...
    agent_howto_direct: 'Pressing "Send the request" files it right away, no login needed: the new homes appear with the next daily update, within 24 hours.',
    agent_send: '📨 Send the request', agent_sending: 'Sending…', agent_cancel: 'Cancel',
    agent_fallback: 'Direct send failed — send via GitHub →',
    t_agent_ok: 'Request sent ✅ Homes for this area arrive with the next update',
