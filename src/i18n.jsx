...
const STR = {
  it: {
    ...
    sync_explain: 'Porta preferiti, note e avvisi da un dispositivo all\'altro con un codice: genera il codice qui, poi inseriscilo sull\'altro dispositivo (telefono ↔ computer). I dati si uniscono, nulla viene cancellato.',
  ...
  en: {
    ...
    sync_explain: 'Carry favourites, notes and alerts between devices with a code: generate it here, then enter it on the other device (phone ↔ computer). Data is merged, nothing gets deleted.',
