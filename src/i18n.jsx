...
const STR = {
  it: {
    ...
    al_push_on: '✅ Notifiche push attive su questo dispositivo: ti avvisiamo anche quando il portale è chiuso.',
    al_push_off: "Le novità compaiono qui quando apri il portale. Attivando un avviso ti chiediamo il permesso per le notifiche del browser, così ti avvisiamo anche a portale chiuso.",
    al_push_denied: '⚠️ Notifiche del browser bloccate: le novità compaiono solo qui dentro. Per riattivarle usa le impostazioni del sito (icona lucchetto nella barra degli indirizzi).',
  ...
  en: {
    ...
    al_push_on: '✅ Push notifications active on this device: we notify you even with the portal closed.',
    al_push_off: 'News shows up here when you open the portal. Enabling an alert asks for browser notification permission, so we can reach you even with the portal closed.',
    al_push_denied: '⚠️ Browser notifications blocked: news only appears in here. Re-enable them from the site settings (padlock icon in the address bar).',
