...
const STR = {
  it: {
    ...
    agent_done_ok: '✅ Fatto! Le case della zona richiesta sono pronte.', agent_done_none: 'ℹ️ Richiesta gestita: al momento non c\'è nulla in vendita in quella zona.',
  ...
  en: {
    ...
    agent_done_ok: '✅ Done! The homes for your requested area are ready.', agent_done_none: 'ℹ️ Request handled: nothing is for sale in that area right now.',
