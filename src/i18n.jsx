...
const STR = {
  it: {
    ...
    near_me: '📍 Vicino a me',
    banner: '🌊 Annunci reali da 5 portali (Rightmove, OnTheMarket, s1homes, ESPC, MyHome.ie) — coste e laghi di Scozia + costa del Donegal (Irlanda) · aggiornato {date}',
    ...
    poi_beach: 'spiaggia', poi_pub: 'pub/ristorante', poi_shop: 'spesa', poi_station: 'stazione', poi_golf: 'golf',
    near_title: '🍺 Vicino a casa (OpenStreetMap)', near_counts: '{p} pub/bar · {r} ristoranti · {c} caffè entro 1,5 km', near_none: 'Nessun locale entro 1,5 km sulla mappa OSM: zona tranquilla (o poco mappata).', near_loading: 'Cerco i locali vicini…', link_site: 'sito', link_maps: 'foto e recensioni', near_more: 'e altri {n}',
    map_pubs: '🍺 Pub', map_pubs_title: 'Pub, bar e ristoranti (OpenStreetMap) — da zoom 13', map_pubs_zoom: 'Zooma sulla zona per vedere i pub 🍺',
    ...
    map_legend: '✨ nuova ≤3 gg · 💎 occasione con vista/giardino sotto media · bordo blu = vista mare',
    nav_prev: '‹ Precedente', nav_next: 'Successiva ›', nav_pos: '{i} di {n}', nav_hint: 'Scorri le case dei risultati senza chiudere la scheda',
    sort_drop: '📉 Ribasso % ↓',
    ...
    lb_hint: 'Scorri per sfogliare · doppio tocco per ingrandire · ✕ o Esc per chiudere', gal_zoom: 'Tocca per ingrandire',
    area_all: 'Tutte le aree', area_label: 'Area',
    searches_chip: 'Ricerche', searches_title: 'Le mie ricerche', searches_save: 'Salva la ricerca attuale', searches_name_ph: 'Nome (es. Vista mare ≤ 400k)', searches_empty: 'Nessuna ricerca salvata: imposta i filtri e salvali qui.', t_search_saved: 'Ricerca salvata 📌', t_search_applied: 'Ricerca «{n}» applicata',
    show_more: 'Mostra altre {n} case', shown_of: '{a} di {n} case mostrate',
    travel_any: '🚗 Viaggio: qualsiasi', travel_90: '🚗 ≤ 1h30 dall’aeroporto', travel_150: '🚗 ≤ 2h30 dall’aeroporto', travel_240: '🚗 ≤ 4h dall’aeroporto', travel_note: 'Tempo d’auto dall’aeroporto più vicino (calcolato ogni notte); le case senza tempo calcolato restano fuori dal filtro.', sort_travel: '🚗 Viaggio ↑', travel_card: '{t} da {g}',
    f_epc: 'Classe energetica (min)', epc_badge: 'EPC {e}', st_ctax: 'Council tax',
    desc_source: 'Dall’annuncio originale',
    trip_chip: 'Giro visite', trip_title: 'Giro delle visite', trip_explain: 'Scegli le case da vedere e l’aeroporto di arrivo: l’ordine più corto in auto, con i tempi tra una casa e l’altra. Fino a 10 tappe.', trip_from: 'Parto da', trip_computing: 'Calcolo il percorso…', trip_err: 'Percorso non calcolabile ora (servizio OSRM occupato): riprova tra poco.', trip_total: 'Totale {t} · {km} km · {n} tappe', trip_gmaps: 'Apri il percorso in Google Maps', stats_trend: '28 gg', stats_trend_title: 'Variazione della mediana rispetto a 28 giorni fa', stats_week: 'Ultimi 7 giorni: {n} nuove case · {s} uscite dal mercato · {t} in totale',
  ...
  en: {
    ...
    near_me: '📍 Near me',
    banner: '🌊 Real listings from 5 portals (Rightmove, OnTheMarket, s1homes, ESPC, MyHome.ie) — Scotland coasts & lochs + the Donegal coast (Ireland) · updated {date}',
    ...
    poi_beach: 'beach', poi_pub: 'pub/restaurant', poi_shop: 'groceries', poi_station: 'station', poi_golf: 'golf',
    near_title: '🍺 Around the house (OpenStreetMap)', near_counts: '{p} pubs/bars · {r} restaurants · {c} cafés within 1.5 km', near_none: 'No venues within 1.5 km on the OSM map: quiet spot (or thinly mapped).', near_loading: 'Looking for places nearby…', link_site: 'website', link_maps: 'photos & reviews', near_more: 'and {n} more',
    map_pubs: '🍺 Pubs', map_pubs_title: 'Pubs, bars and restaurants (OpenStreetMap) — from zoom 13', map_pubs_zoom: 'Zoom in to see the pubs 🍺',
    ...
    map_legend: '✨ new ≤3 days · 💎 deal with view/garden below median · blue border = sea view',
    nav_prev: '‹ Previous', nav_next: 'Next ›', nav_pos: '{i} of {n}', nav_hint: 'Step through the results without closing the sheet',
    sort_drop: '📉 Reduction % ↓',
    ...
    lb_hint: 'Swipe to browse · double-tap to zoom · ✕ or Esc to close', gal_zoom: 'Tap to enlarge',
    area_all: 'All areas', area_label: 'Area',
    searches_chip: 'Searches', searches_title: 'My searches', searches_save: 'Save the current search', searches_name_ph: 'Name (e.g. Sea view ≤ 400k)', searches_empty: 'No saved searches yet: set your filters and save them here.', t_search_saved: 'Search saved 📌', t_search_applied: 'Search "{n}" applied',
    show_more: 'Show {n} more homes', shown_of: '{a} of {n} homes shown',
    travel_any: '🚗 Drive: any', travel_90: '🚗 ≤ 1h30 from the airport', travel_150: '🚗 ≤ 2h30 from the airport', travel_240: '🚗 ≤ 4h from the airport', travel_note: 'Driving time from the nearest airport (computed nightly); homes without a computed time are left out of the filter.', sort_travel: '🚗 Drive ↑', travel_card: '{t} from {g}',
    f_epc: 'Energy rating (min)', epc_badge: 'EPC {e}', st_ctax: 'Council tax',
    desc_source: 'From the original listing',
    trip_chip: 'Viewing trip', trip_title: 'Viewing trip', trip_explain: 'Pick the homes to view and the airport you land at: the shortest driving order, with times between stops. Up to 10 stops.', trip_from: 'Start from', trip_computing: 'Computing the route…', trip_err: 'Route unavailable right now (OSRM busy): try again shortly.', trip_total: 'Total {t} · {km} km · {n} stops', trip_gmaps: 'Open the route in Google Maps', stats_trend: '28 d', stats_trend_title: 'Change of the median vs 28 days ago', stats_week: 'Last 7 days: {n} new homes · {s} left the market · {t} in total',
