...
// Per-zone market snapshot: counts, median/min/max asking price, sea-view
// share, reductions and sold-archive entries. Rows apply the zone filter.
export default function StatsModal({ zones, listings, sold, onPickZone, onClose }) {
  const { t } = useI18n()
