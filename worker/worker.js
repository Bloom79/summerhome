...
export default {
  ...
  async fetch(request, env) {
    ...
    if (u.pathname === '/analizza') {
      ...
      if (!/^https:\/\/(www\.rightmove\.co\.uk|www\.onthemarket\.com|www\.s1homes\.com|www\.myhome\.ie|tspc\.co\.uk|espc\.com|www\.aspc\.co\.uk|www\.futurepropertyauctions\.co\.uk|www\.auctionhouse\.co\.uk|primepropertyauctions\.co\.uk)\//.test(url2))
